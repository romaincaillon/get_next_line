...
#    Updated: 2018/11/09 20:49:11 by rcaillon         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
		  ...
		  ft_striter.c ft_striteri.c ft_strcmp.c ft_strmapi.c ft_strequ.c \
...
OBJECTS = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
		  ...
		  ft_striter.o ft_striteri.o ft_strcmp.o ft_strmapi.o ft_strequ.o \
